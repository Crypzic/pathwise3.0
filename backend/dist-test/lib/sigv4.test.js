...
import { EMPTY_PAYLOAD_HASH, sha256Hex, signingKey, signRequest, } from "./sigv4.js";
...
test("S3 GET object example produces the documented signature", () => {
    ...
    assert.match(headers.authorization, /Credential=AKIAIOSFODNN7EXAMPLE\/20130524\/us-east-1\/s3\/aws4_request/);
...
test("S3 PUT object example produces the documented signature", () => {
    ...
    assert.match(headers.authorization, /Signature=98ad721746da40c64f1a55b78f14c238d841ea1380cd77a1b5971af0ece108bd$/);
});
// --- Structural checks ------------------------------------------------------
