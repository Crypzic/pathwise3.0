...
import { COMPANION_STAGES, LEAF_MATCH_PAIRS, leafMatchReward, stageFor, } from "./gardenModel.js";
test("companion stages advance with growth", () => {
    ...
    assert.equal(stageFor(999_999).stage, COMPANION_STAGES[COMPANION_STAGES.length - 1].stage);
});
