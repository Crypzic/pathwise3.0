...
import { ACADEMIC_LEVELS, CONTENT_PREFS, STUDY_STYLES, isAcademicLevel, isStudyStyle, normalizeContentPrefs, normalizeFreeList, normalizeBuddyPrefs, parseStoredList, } from "./onboardingModel.js";
...
test("buddy prefs coerce arbitrary shapes into a well-formed object", () => {
    ...
    assert.deepEqual(normalizeBuddyPrefs({
        similarLevel: true,
