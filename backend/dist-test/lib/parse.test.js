...
function item(str, y, hasEOL = false) {
...
test("only PDF, DOCX and PPTX are accepted", () => {
    ...
    assert.equal(kindFor("notes.docx", "application/vnd.openxmlformats-officedocument.wordprocessingml.document"), "docx");
    assert.equal(kindFor("slides.pptx", "application/vnd.openxmlformats-officedocument.presentationml.presentation"), "pptx");
