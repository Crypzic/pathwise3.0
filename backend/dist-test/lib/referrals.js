 ...
 */
export async function attachReferral(refereeId, code) {
...
async function payOut(userId, role) {
    await prisma.user.update({
        where: { id: userId },
        data: {
 ...
 */
export async function maybeRewardReferral(refereeId) {
 ...
 */
export async function referralStatus(userId, appUrl) {
