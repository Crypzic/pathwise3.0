...
export default async function errorRoutes(app) {
    app.post("/api/client-errors", { config: { rateLimit: { max: 10, timeWindow: "10 minutes" } } }, async (req, reply) => {
        const bounded = boundReport((req.body ?? {}));
        if (!bounded) {
